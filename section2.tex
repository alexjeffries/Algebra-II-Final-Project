...
\begin{frame}
  ...
  \begin{definition}
    ...
    We say that $\pi_1$ is \alert{long} (resp. \alert{short}) if there is a pair of mutually nondegenerate irredicible factorizations
    \begin{align*}
      \pi_1\pi_2\cdots\pi_n = \xi_1\xi_2\cdots \xi_m
    \end{align*}
...
\begin{frame}
  ...
  \begin{fact}
    ...
    That is, any two mutually nondegenerate irreducible factroizations of different lenghts are of the form (up to associates):
